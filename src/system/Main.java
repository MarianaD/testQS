...
/*
		...
		Music m1 = new MusicClass("MusicaA", "Mariana", 2, MusicClass.FORMAT_MP3, 3);
		...
		Music m4 = new MusicClass("MusicaB", "Mariana", 2, MusicClass.FORMAT_AIFF, 4);
		...
		*/
		...
		Music a2 = new MusicClass("MusicaA1", "marte", 3, MusicClass.FORMAT_AIFF, 4);
		Music a3 = new MusicClass("MusicaA3", "Marte", 5, MusicClass.FORMAT_AIFF, 4);
		...
		Music b0 = new MusicClass("MusicaB1", "Mercurio", 3, MusicClass.FORMAT_AIFF, 1);
		Music b1 = new MusicClass("MusicaB1", "Mercurio", 3, MusicClass.FORMAT_AIFF, 1);
		Music b2 = new MusicClass("MusicaB2", "Mercurio", 1, MusicClass.FORMAT_AIFF, 2);
		Music b3 = new MusicClass("MusicaB3", "Mercurio", 7, MusicClass.FORMAT_AIFF, 2);
		Music b4 = new MusicClass("MusicaB4", "Mercurio", 6, MusicClass.FORMAT_AIFF, 2);
		Music c1 = new MusicClass("MC1", "Jupiter", 7, "wav", 5);
		Music c2 = new MusicClass("MC2", "Jupiter", 1, MusicClass.FORMAT_AIFF, 1);
		...
		Music d2 = new MusicClass("MusicaA3", "Jupiter", 3, MusicClass.FORMAT_AIFF, 1);
		p.addMusic(d1);
		p.addMusic(d2);

		Music d3 = new MusicClass("A rapariga que bla bla", "Jupiter", 7, "wav", 5);
		Music d4 = new MusicClass("Bola no ar", "Jupiter", 3, MusicClass.FORMAT_AIFF, 1);
		p.addMusic(d3);
		p.addMusic(d4);
